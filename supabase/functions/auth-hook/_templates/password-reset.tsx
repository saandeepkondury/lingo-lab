...
export const PasswordResetEmail = ({
  ...
  <Html>
    <Head />
    <Preview>Reset your LingoLab password</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={resetSection}>
          <Text style={text}>
            Hi there! We received a request to reset the password for your LingoLab account associated with <strong>{email}</strong>.
          </Text>
          ...
          <Text style={orText}>Or copy and paste this reset code:</Text>
