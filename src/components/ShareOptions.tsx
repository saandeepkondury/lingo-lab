...
const ShareOptions = ({
  ...
  return <Dialog>
      <DialogTrigger asChild>
        {trigger || <Button variant="outline" size="sm" className="flex items-center space-x-1 bg-white text-zinc-900">
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="grid gap-4 py-4">
          <div className="flex flex-col gap-3">
            <Button variant="outline" className="flex justify-start items-center gap-3" onClick={() => handleShare('twitter')}>
              <X className="h-5 w-5" />
              <span>Share on X.com</span>
            </Button>
            
            <Button variant="outline" className="flex justify-start items-center gap-3" onClick={() => handleShare('linkedin')}>
              <Linkedin className="h-5 w-5" />
              <span>Share on LinkedIn</span>
            </Button>
            
            <Button variant="outline" className="flex justify-start items-center gap-3" onClick={() => handleShare('email')}>
              <Mail className="h-5 w-5" />
              <span>Share via Email</span>
            </Button>
            
            <Button variant="outline" className="flex justify-start items-center gap-3" onClick={copyToClipboard}>
